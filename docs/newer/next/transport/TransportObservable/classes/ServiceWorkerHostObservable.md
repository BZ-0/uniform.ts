...
[@fest-lib/uniform](../../../../../README.md) / [newer/next/transport/TransportObservable](../README.md) / ServiceWorkerHostObservable

# Class: ServiceWorkerHostObservable

Defined in: modules/projects/uniform.ts/src/newer/next/transport/TransportObservable.ts:272

ServiceWorker Host Observable

## Extends

- [`TransportObservable`](TransportObservable.md)\<[`ChannelMessage`](../../../types/Interface/interfaces/ChannelMessage.md) & `object`\>
...
```ts
new ServiceWorkerHostObservable(): ServiceWorkerHostObservable;
```
...
Defined in: modules/projects/uniform.ts/src/newer/next/transport/TransportObservable.ts:275

#### Parameters

##### value

[`ChannelMessage`](../../../types/Interface/interfaces/ChannelMessage.md)\<`any`\> & `object`
...
##### observerOrNext
  ...
  \| [`Observer`](../../../types/Interface/interfaces/Observer.md)\<[`ChannelMessage`](../../../types/Interface/interfaces/ChannelMessage.md)\<`any`\> & `object`\>
  \| ((`v`) => `void`)
