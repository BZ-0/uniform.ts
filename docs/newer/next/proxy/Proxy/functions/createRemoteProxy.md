...
[@fest-lib/uniform](../../../../../README.md) / [newer/next/proxy/Proxy](../README.md) / createRemoteProxy

# Function: createRemoteProxy()

```ts
function createRemoteProxy<T>(invoker, config): RemoteProxy<T>;
```

Defined in: modules/projects/uniform.ts/src/newer/next/proxy/Proxy.ts:307
