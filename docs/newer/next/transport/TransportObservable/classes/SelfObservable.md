...
[@fest-lib/uniform](../../../../../README.md) / [newer/next/transport/TransportObservable](../README.md) / SelfObservable

# Class: SelfObservable

Defined in: modules/projects/uniform.ts/src/newer/next/transport/TransportObservable.ts:287
...
```ts
new SelfObservable(): SelfObservable;
```
...
Defined in: modules/projects/uniform.ts/src/newer/next/transport/TransportObservable.ts:290
