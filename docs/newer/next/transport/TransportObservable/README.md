...
[@fest-lib/uniform](../../../../README.md) / newer/next/transport/TransportObservable

# newer/next/transport/TransportObservable
...
- [TransportObservable](classes/TransportObservable.md)
- [WebSocketObservable](classes/WebSocketObservable.md)
- [WorkerObservable](classes/WorkerObservable.md)

## Variables

- [TransportObservableFactory](variables/TransportObservableFactory.md)
